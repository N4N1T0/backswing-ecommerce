    ...
    <main className='max-w-screen-3xl mx-auto p-10 space-y-5'>
      ...
      <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-4'>
        ...
        <table className='text-center [&>caption]:my-5'>
          <caption className='font-medium text-xl'>HOMBRE - 10 TALLAS DISPONIBLES</caption>
        ...
        {/* Mujer */}
        <table className='text-center [&>caption]:my-5'>
          <caption className='font-medium text-xl'>MUJER - 6 TALLAS DISPONIBLES</caption>
          <tr className='bg-gray-950 text-white [&>th]:p-4 divide-x-2'>
            <th>TALLAS</th>
            <th>S</th>
            <th>M</th>
        ...
        {/* Niños */}
        <table className='text-center [&>caption]:my-5'>
          <caption className='font-medium text-xl'>NIÑOS - 6 TALLAS DISPONIBLES</caption>
          <tr className='bg-gray-950 text-white [&>th]:p-4 divide-x-2'>
            <th>TALLAS</th>
            <th>4 años</th>
            <th>6 años</th>
