	...
	return (
		<Accordion type='multiple' defaultValue={['descripcion']}>
			<AccordionItem value='descripcion' className='border-secondary/50'>
				...
				<AccordionContent>
					a 1a camiseta del mercado 100% pretratada para facilitar la impresión
					digital Algodón semipeinado para una excelente relación calidad/precio
			...
			<AccordionItem value='composition' className='border-secondary/50'>
				...
				<AccordionContent>
					100% algodón (85% algodón - 15% algodón biológico) - Enteramente
					pretratada para una impresión digital completa
				</AccordionContent>
			</AccordionItem>
