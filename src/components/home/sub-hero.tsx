    ...
    <section id='sub-hero'>
      <div className='mx-auto max-w-screen-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8'>
        <ul className='mt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
          ...
          <li className='lg:col-span-2 lg:row-span-2 lg:row-start-1 lg:col-start-1 xl:col-span-2 xl:row-span-2 xl:col-start-3 xl:row-start-2'>
            <Link href='#' className='group relative block'>
              <img
          ...
          <li className='xl:col-span-2 xl:row-span-2 xl:row-start-1'>
            <Link href='#' className='group relative block'>
              <img
                src='https://images.unsplash.com/photo-1593795899768-947c4929449d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2672&q=80'
                alt=''
