            ...
            <div className='mx-auto max-w-md text-center lg:text-left'>
              ...
              <header>
                ...
                <p className='mt-4 text-gray-700'>
                  Explora nuestra nueva colección de sudaderas, gorros
                  y más. Con calidad premium y diseños vanguardistas, cada artículo
                  está diseñado para hombres y mujeres que adoran el pádel y la moda.
                </p>
              </header>
              ...
              {products.map((product) => {
                ...
                return (
                  <li key={product.id} className='relative'>
                    <Link href={`/${gender?.toLowerCase()}/${category?.toLowerCase()}/${id}`} className='group block'>
                      <Image
                        src={image.sourceUrl}
                        alt={parsedName}
                        title={parsedName}
                      ...
                      <div className='mt-3'>
                        ...
                        <p className='mt-1 text-sm text-gray-700'>{parsedPrice}</p>
                      </div>
                    </Link>
                  </li>
                )
