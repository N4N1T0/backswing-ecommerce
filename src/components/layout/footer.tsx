        ...
        <div className='lg:flex lg:items-end lg:justify-between border-b py-3 border-gray-300'>
          ...
          >
            {footerItems.map(items => (
              <li key={items.label}>
                <Link className='text-gray-950 text-sm md:text-base transition-colors duration-200 hover:text-gray-500' href={items.route} title={items.label}>{items.label}</Link>
              </li>
            ))}
          </ul>
        </div>
