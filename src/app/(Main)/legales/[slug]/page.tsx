  ...
  return (
    <main className='max-w-screen-2xl mx-auto p-10 space-y-5'>
      ...
      <p className='text-gray-800 leading-7'>
        ...
        productos. <a href='https://backswing.com'>Backswing</a> no asume la
      ...
      <p className='text-gray-800 leading-7'>
        Backswing a través de su sitio web concede una licencia para que los
      ...
      <p className='text-gray-800 leading-7'>
        ...
        garantía solo cubrirá fallas de fábrica y solo se hará efectiva cuando
        ...
        normales de los productos y solo se harán efectivos estos términos si el
      ...
      <p className='text-gray-800 leading-7'>
        Este <a href='https://backswing.com'>Backswing</a> garantiza que la
      ...
      <p className='text-gray-800 leading-7'>
        <a href='https://backswing.com'>Backswing</a> reserva los derechos de
