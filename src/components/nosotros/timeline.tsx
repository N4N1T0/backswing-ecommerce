						...
						<div className='space-y-2 lg:space-y-4'>
							<div>
								<div className='flex flex-col items-center'>
										...
										<div className='w-full lg:w-1/2 lg:pr-8'>
											<div className='relative flex-1 mb-10 bg-white rounded shadow lg:mb-8'>
												<div className='absolute inline-block w-4 overflow-hidden -translate-y-1/2 top-3 -right-4'>
													<div className='hidden h-10 origin-bottom-left transform -rotate-45 bg-white shadow lg:block' />
												</div>
												<div className='relative z-20 '>
													<div className='flex flex-wrap items-center'>
														<div className='p-4 md:w-1/4 flex flex-col justify-center items-center text-center gap-3'>
															...
															<p className='text-4xl font-bold text-gray-700 text-bold'>
																1 Dia
															</p>
														</div>
														<div className='flex-1 p-4 pr-4 border-l border-gray-300'>
															...
															<p className='text-gray-700'>
																Una vez que recibimos su pedido de camiseta de
																pádel con el diseño seleccionado, enviamos una
																confirmación por correo electrónico con todos
									...
									<div className='absolute flex items-center justify-center w-10 h-10 p-2 transform -translate-x-1/2 -translate-y-4 bg-gray-900 rounded-full left-1/2 lg:translate-y-[4px]'>
										...
										<div className='w-full lg:w-1/2 lg:pl-8'>
											<div className='relative flex-1 mb-10 bg-white rounded shadow lg:mb-8'>
												<div className='absolute inline-block w-4 overflow-hidden -translate-y-1/2 top-7 -left-4'>
													<div className='hidden h-10 origin-top-right transform -rotate-45 bg-white lg:block drop-shadow-lg' />
												</div>
												<div className='relative z-20 '>
													<div className='flex flex-wrap items-center'>
														<div className='p-4 md:w-1/4 flex flex-col justify-center items-center text-center gap-3'>
														...
														<div className='flex-1 p-4 pr-4 border-l border-gray-300'>
															...
															<p className='text-gray-700'>
																Nuestro equipo comienza a trabajar en su pedido,
																imprimiendo y personalizando la camiseta según
												...
												<div className='relative z-20 '>
													<div className='flex flex-wrap items-center'>
														...
														<div className='flex-1 p-4 pr-4 border-l border-gray-300'>
															...
															<p className='text-gray-700'>
																Cada camiseta pasa por rigurosos controles de
																calidad para garantizar que cumpla con nuestros
																estándares antes de ser enviada.
															</p>
														</div>
													</div>
												</div>
												...
												<div className='relative z-20 '>
													<div className='flex flex-wrap items-center'>
														...
														<div className='flex-1 p-4 pr-4 border-l border-gray-300'>
															...
															<p className='text-gray-700'>
																Una vez aprobada, empacamos cuidadosamente su
																camiseta en un paquete seguro y coordinamos su
																envío con una empresa de confianza.
															</p>
														</div>
													</div>
												</div>
